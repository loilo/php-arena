var dependencyFilename = "/php-arena/php-wasm/0b1ff160f1a36612.wasm";

const dependenciesTotalSize = 5872403; 
...
function _js_create_input_device(deviceId) {
 ...
 FS.createDevice("/dev", filename, (function() {}), (function(byte) {
  try {
  ...
  for (var x in imports) {
   (function(x) {
    ...
    if (typeof original == "function") {
     original.isAsync || importPatterns.some((pattern => !!x.match(pattern)));
    }
   })(x);
  }
 },
...
Module["_wasm_popen"] = function() {
 return (Module["_wasm_popen"] = Module["asm"]["gb"]).apply(null, arguments);
};

Module["_wasm_php_exec"] = function() {
 return (Module["_wasm_php_exec"] = Module["asm"]["hb"]).apply(null, arguments);
};

Module["_php_pollfd_for"] = function() {
 return (Module["_php_pollfd_for"] = Module["asm"]["ib"]).apply(null, arguments);
};
...
Module["_wasm_sleep"] = function() {
 return (Module["_wasm_sleep"] = Module["asm"]["mb"]).apply(null, arguments);
};

Module["_wasm_read"] = function() {
 return (Module["_wasm_read"] = Module["asm"]["nb"]).apply(null, arguments);
};
...
Module["___wrap_select"] = function() {
 return (Module["___wrap_select"] = Module["asm"]["pb"]).apply(null, arguments);
};

Module["_wasm_set_sapi_name"] = function() {
 return (Module["_wasm_set_sapi_name"] = Module["asm"]["qb"]).apply(null, arguments);
};

Module["_wasm_set_phpini_path"] = function() {
 return (Module["_wasm_set_phpini_path"] = Module["asm"]["rb"]).apply(null, arguments);
};

Module["_wasm_set_phpini_entries"] = function() {
 return (Module["_wasm_set_phpini_entries"] = Module["asm"]["sb"]).apply(null, arguments);
};

Module["_wasm_add_SERVER_entry"] = function() {
 return (Module["_wasm_add_SERVER_entry"] = Module["asm"]["tb"]).apply(null, arguments);
};

Module["_wasm_add_ENV_entry"] = function() {
 return (Module["_wasm_add_ENV_entry"] = Module["asm"]["ub"]).apply(null, arguments);
};

Module["_wasm_set_query_string"] = function() {
 return (Module["_wasm_set_query_string"] = Module["asm"]["vb"]).apply(null, arguments);
};

Module["_wasm_set_path_translated"] = function() {
 return (Module["_wasm_set_path_translated"] = Module["asm"]["wb"]).apply(null, arguments);
};

Module["_wasm_set_skip_shebang"] = function() {
 return (Module["_wasm_set_skip_shebang"] = Module["asm"]["xb"]).apply(null, arguments);
};

Module["_wasm_set_request_uri"] = function() {
 return (Module["_wasm_set_request_uri"] = Module["asm"]["yb"]).apply(null, arguments);
};

Module["_wasm_set_request_method"] = function() {
 return (Module["_wasm_set_request_method"] = Module["asm"]["zb"]).apply(null, arguments);
};

Module["_wasm_set_request_host"] = function() {
 return (Module["_wasm_set_request_host"] = Module["asm"]["Ab"]).apply(null, arguments);
};

Module["_wasm_set_content_type"] = function() {
 return (Module["_wasm_set_content_type"] = Module["asm"]["Bb"]).apply(null, arguments);
};

Module["_wasm_set_request_body"] = function() {
 return (Module["_wasm_set_request_body"] = Module["asm"]["Cb"]).apply(null, arguments);
};

Module["_wasm_set_content_length"] = function() {
 return (Module["_wasm_set_content_length"] = Module["asm"]["Db"]).apply(null, arguments);
};

Module["_wasm_set_cookies"] = function() {
 return (Module["_wasm_set_cookies"] = Module["asm"]["Eb"]).apply(null, arguments);
};

Module["_wasm_set_php_code"] = function() {
 return (Module["_wasm_set_php_code"] = Module["asm"]["Fb"]).apply(null, arguments);
};

Module["_wasm_set_request_port"] = function() {
 return (Module["_wasm_set_request_port"] = Module["asm"]["Gb"]).apply(null, arguments);
};

Module["_wasm_sapi_request_shutdown"] = function() {
 return (Module["_wasm_sapi_request_shutdown"] = Module["asm"]["Hb"]).apply(null, arguments);
};

Module["_wasm_sapi_handle_request"] = function() {
 return (Module["_wasm_sapi_handle_request"] = Module["asm"]["Ib"]).apply(null, arguments);
};

Module["_php_wasm_init"] = function() {
 return (Module["_php_wasm_init"] = Module["asm"]["Jb"]).apply(null, arguments);
};
...
export { dependenciesTotalSize, dependencyFilename, init };
