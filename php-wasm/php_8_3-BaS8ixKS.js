var dependencyFilename = "/php-arena/php-wasm/4e9b85d7a5e51cde.wasm";

const dependenciesTotalSize = 13565348; 
...
Module["_wasm_popen"] = function() {
 return (Module["_wasm_popen"] = Module["asm"]["hb"]).apply(null, arguments);
};

Module["_wasm_php_exec"] = function() {
 return (Module["_wasm_php_exec"] = Module["asm"]["ib"]).apply(null, arguments);
};

Module["_php_pollfd_for"] = function() {
 return (Module["_php_pollfd_for"] = Module["asm"]["jb"]).apply(null, arguments);
};
...
Module["_wasm_sleep"] = function() {
 return (Module["_wasm_sleep"] = Module["asm"]["nb"]).apply(null, arguments);
};
...
Module["_wasm_read"] = function() {
 return (Module["_wasm_read"] = Module["asm"]["pb"]).apply(null, arguments);
};

Module["___wrap_select"] = function() {
 return (Module["___wrap_select"] = Module["asm"]["qb"]).apply(null, arguments);
};

Module["_wasm_set_sapi_name"] = function() {
 return (Module["_wasm_set_sapi_name"] = Module["asm"]["rb"]).apply(null, arguments);
};

Module["_wasm_set_phpini_path"] = function() {
 return (Module["_wasm_set_phpini_path"] = Module["asm"]["sb"]).apply(null, arguments);
};

Module["_wasm_set_phpini_entries"] = function() {
 return (Module["_wasm_set_phpini_entries"] = Module["asm"]["tb"]).apply(null, arguments);
};

Module["_wasm_add_SERVER_entry"] = function() {
 return (Module["_wasm_add_SERVER_entry"] = Module["asm"]["ub"]).apply(null, arguments);
};

Module["_wasm_add_ENV_entry"] = function() {
 return (Module["_wasm_add_ENV_entry"] = Module["asm"]["vb"]).apply(null, arguments);
};

Module["_wasm_set_query_string"] = function() {
 return (Module["_wasm_set_query_string"] = Module["asm"]["wb"]).apply(null, arguments);
};

Module["_wasm_set_path_translated"] = function() {
 return (Module["_wasm_set_path_translated"] = Module["asm"]["xb"]).apply(null, arguments);
};

Module["_wasm_set_skip_shebang"] = function() {
 return (Module["_wasm_set_skip_shebang"] = Module["asm"]["yb"]).apply(null, arguments);
};

Module["_wasm_set_request_uri"] = function() {
 return (Module["_wasm_set_request_uri"] = Module["asm"]["zb"]).apply(null, arguments);
};

Module["_wasm_set_request_method"] = function() {
 return (Module["_wasm_set_request_method"] = Module["asm"]["Ab"]).apply(null, arguments);
};

Module["_wasm_set_request_host"] = function() {
 return (Module["_wasm_set_request_host"] = Module["asm"]["Bb"]).apply(null, arguments);
};

Module["_wasm_set_content_type"] = function() {
 return (Module["_wasm_set_content_type"] = Module["asm"]["Cb"]).apply(null, arguments);
};

Module["_wasm_set_request_body"] = function() {
 return (Module["_wasm_set_request_body"] = Module["asm"]["Db"]).apply(null, arguments);
};

Module["_wasm_set_content_length"] = function() {
 return (Module["_wasm_set_content_length"] = Module["asm"]["Eb"]).apply(null, arguments);
};

Module["_wasm_set_cookies"] = function() {
 return (Module["_wasm_set_cookies"] = Module["asm"]["Fb"]).apply(null, arguments);
};

Module["_wasm_set_php_code"] = function() {
 return (Module["_wasm_set_php_code"] = Module["asm"]["Gb"]).apply(null, arguments);
};

Module["_wasm_set_request_port"] = function() {
 return (Module["_wasm_set_request_port"] = Module["asm"]["Hb"]).apply(null, arguments);
};

Module["_wasm_sapi_request_shutdown"] = function() {
 return (Module["_wasm_sapi_request_shutdown"] = Module["asm"]["Ib"]).apply(null, arguments);
};
