...
<template>
  <ActionTrigger
    ...
    :aria-pressed="
      themeStore.auto ? 'mixed' : String(themeStore.theme === 'dark')
    "
    ...
    <span class="switch__slider">
      ...
      >
        <Icon
          ...
          class="h-4 w-4"
          :class="themeStore.auto ? 'block' : 'hidden'"
        />
        <Icon
          name="sun"
          alt="Light Mode"
          class="h-4 w-4"
          :class="
            !themeStore.auto && themeStore.theme === 'light'
              ? 'block'
              : 'hidden'
          "
        />
        <Icon
          ...
          class="h-4 w-4"
          :class="
            !themeStore.auto && themeStore.theme === 'dark' ? 'block' : 'hidden'
          "
        />
      </span>
    </span>
...
.switch {
  ...
  --highlight-strong: theme('colors.violet.600');

  @at-root :root.dark & {
    --background: theme('colors.slate.700');
    --foreground: theme('colors.slate.300');
    --highlight-strong: theme('colors.violet.500');
  }
